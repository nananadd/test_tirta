    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 45%;">Kode Sales</th>
                <th>Nama Sales</th>
            </tr>
        </thead>
        <tbody>
            ...
            @forelse($sales as $item)
                <tr>
                    ...
                    <td><span class="badge">{{ $item->kode_sales }}</span></td>
                    <td style="font-weight: bold; color: #34495e;">{{ $item->nama_sales }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="3" style="text-align: center; color: #95a5a6; font-style: italic; padding: 20px;">Tidak ada data sales di database.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
