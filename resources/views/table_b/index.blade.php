...
<div class="row mb-4 align-items-center">
    <div class="col-md-4">
        <h3 class="fw-bold text-dark m-0 ms-3"><i class="fa-solid fa-money-bill-wave text-success me-2"></i> Data Transaksi</h3>
        <p class="text-muted small m-0 mt-1 ms-3">Kelola data transaksi.</p>
    </div>
...
<div class="card bg-white shadow-sm border-0" style="border-radius: 16px;">
    <div class="card-body p-0">
        <div class="card-body p-4 pb-0">
            <form method="GET" action="{{ route('table_b.index') }}" id="searchForm">
                <div class="input-group">
                    ...
                    <input type="text"
                        ...
                        name="search"
                        class="form-control"
                        placeholder="Cari Kode Toko atau Nominal transaksi..."
                    ...
                    @csrf
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <a href="{{ asset('templates/template_transaksi.xlsx') }}" download class="text-decoration-none small text-primary fw-bold">
