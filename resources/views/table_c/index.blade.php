...
<div class="row mb-4 align-items-center">
    <div class="col-md-4">
        <h3 class="fw-bold text-dark m-0"><i class="fa-solid fa-map-location-dot text-primary me-2"></i> Data Area</h3>
        <p class="text-muted small m-0 mt-1">Kelola data pembagian area.</p>
    </div>
